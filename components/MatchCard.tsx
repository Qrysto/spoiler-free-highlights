  ...
  return (
    <div className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow bg-white">
      ...
      <div className="flex flex-col gap-1 mb-4">
        <div className={`text-lg font-semibold ${fixture.homeTeam.includes('United') ? 'text-red-700' : 'text-gray-900'}`}>
          {fixture.homeTeam}
        </div>
        <div className="text-sm text-gray-500">vs</div>
        <div className={`text-lg font-semibold ${fixture.awayTeam.includes('United') ? 'text-red-700' : 'text-gray-900'}`}>
          {fixture.awayTeam}
        </div>
      </div>
